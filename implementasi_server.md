...
Branch backup saat dokumen ini dibuat: `feat/backup-v97`.
...
git clone -b feat/backup-v97 https://github.com/RakitTech/khansa_kirana_new.git /var/www/khansa_kirana_new
