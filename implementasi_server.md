...
Branch backup saat dokumen ini dibuat: `feat/backup-v34`.
...
git clone -b feat/backup-v34 https://github.com/RakitTech/khansa_kirana_new.git /var/www/khansa_kirana_new
