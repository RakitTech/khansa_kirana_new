...
Branch backup saat dokumen ini dibuat: `feat/backup-v1`.
...
git clone -b feat/backup-v1 https://github.com/RakitTech/khansa_kirana_new.git /var/www/khansa_kirana_new
