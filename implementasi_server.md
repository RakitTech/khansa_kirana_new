...
Branch backup saat dokumen ini dibuat: `feat/backup-v8`.
...
git clone -b feat/backup-v8 https://github.com/RakitTech/khansa_kirana_new.git /var/www/khansa_kirana_new
