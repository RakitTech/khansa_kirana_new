...
Branch backup saat dokumen ini dibuat: `feat/backup-v48`.
...
git clone -b feat/backup-v48 https://github.com/RakitTech/khansa_kirana_new.git /var/www/khansa_kirana_new
